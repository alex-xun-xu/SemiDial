...
class DataIO():
    def __init__(self,batch_size, seed_split=0, seed_label=8, label_percent=0.05,
                 data_path=os.path.abspath(os.path.join(pathlib.Path(__file__).parent.resolve(),'../Dataset/STARE128')),
                 add_unlab = 'None'):
        '''
        Initialize DataIO
        ...
        self.InitPointer()
        print("【DataIO_STARE/DataIO】seed_label = ", self.seed_label)
