...
class BCDUNet2(nn.Module):
    def __init__(self, input_dim=3, output_dim=3, num_filter=64, frame_size=(256, 256), bidirectional=False,
                 norm='instance',seed_model=3):
        super(BCDUNet2, self).__init__()
